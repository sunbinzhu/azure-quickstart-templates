...
| computeNodeSourceImageVHDName  | The VHD name of the custom compute node image, for example, mycustomhpccn.vhd. The OS of the image must be Windows Server 2012 or Windows Server 2012 R2.|
